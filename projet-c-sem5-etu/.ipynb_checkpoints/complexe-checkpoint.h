 ...
 */
double imaginaire(C complexe_t);
 ...
 */ 
void set_reelle(C complexe_t;R double);
 ...
 * Retourne : Rien (Procedure)
 */ 
void set_imaginaire(C complexe_t;I double);
 ...
 * Retourne : Rien (Procedure)
 */ 
void init(C complexe_t;R double;I double);
